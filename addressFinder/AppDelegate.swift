...
//  addressFinder
//
//  Created by Milica Jankovic on 11/1/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let findAddressViewController = navigationController.topViewController as! FindAddressViewController
        findAddressViewController.managedObjectContext = managedObjectContext
  ...
  print(applicationDocumentsDirectory)
    ...
    //lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
      //  let container = NSPersistentContainer(name: "addressFinder")
